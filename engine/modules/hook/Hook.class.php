 ...
 * Чтобы повесить обработчик на этот хук, его нужно объявить, например, через файл в /engine/hooks/HookTest.class.php
 * <pre>
...
class ModuleHook extends Module
{
     ...
     * Позволяет в качестве обработчика использовать метод хука(класса хука из каталога /engine/hooks/)
     * @see Add
     * @see Hook::AddHook
     *
     * @param string $sName Имя хука
