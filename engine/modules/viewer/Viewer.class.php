...
class ModuleViewer extends Module
{
    ...
    public function Init($bLocal = false)
    {
        ...
        $this->oSmarty->registerPlugin(Smarty::PLUGIN_MODIFIER, 'is_null', 'is_null');
     ...
     * Можно передать название блока, тогда для обработки данных блока будет вызван обработчик из /engine/blocks/, либо передать путь до шаблона, тогда будет выполнено обычное подключение шаблона
