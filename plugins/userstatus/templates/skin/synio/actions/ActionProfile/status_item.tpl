...
{else}
    ...
    <div id="status_editor" style="display:none">
        <div class="editor">
            <input type="text" class="input-text input-width-400" id="editor_text" value=""
                   placeholder="{$aLang.plugin.userstatus.user_status_setup}"/><br/>
            <div class="clearfix">
                <div class="fl-r">
                    <button type="button" class="button button-primary"
                            id="editor_submit">{$aLang.plugin.userstatus.user_status_save}</button>
                    <button type="button" class="button"
                            id="editor_cancel">{$aLang.plugin.userstatus.user_status_cancel}</button>
                </div>
            </div>
        </div>
    </div>
