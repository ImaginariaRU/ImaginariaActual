<table class="table table-blogs" cellspacing="0">
    {if $bBlogsUseOrder}
        ...
        <tr>
            ...
            <th class="cell-name cell-tab">
                <div class="cell-tab-inner {if $sBlogOrder=='blog_title'}active{/if}"><a
            ...
            <th class="cell-readers cell-tab">
                <div class="cell-tab-inner {if $sBlogOrder=='blog_count_user'}active{/if}"><a
                            href="{$sBlogsRootPage}?order=blog_count_user&order_way={if $sBlogOrder=='blog_count_user'}{$sBlogOrderWayNext}{else}{$sBlogOrderWay}{/if}"
    ...
    {else}
        ...
        <tr>
            ...
            <th class="cell-readers cell-tab">
                <div class="cell-tab-inner"><span>{$aLang.infobox_blog_topics}</span></div>
            </th>
            <th class="cell-readers cell-tab">
                <div class="cell-tab-inner"><span>{$aLang.blogs_readers}</span></div>
            </th>
        </tr>
        </thead>
    {/if}
            ...
            <tr>
                ...
                <td class="cell-name">
                    ...
                    <span class="user-avatar">
							<a href="{$oUserOwner->getUserWebPath()}"><img src="{$oUserOwner->getProfileAvatarPath(24)}"
                                                                           alt="avatar"/></a>
                    ...
                    <td class="cell-join">
                        {if $oUserCurrent->getId() != $oBlog->getOwnerId() and $oBlog->getType() == 'open'}
                            <button type="submit" onclick="ls.blog.toggleJoin(this, {$oBlog->getId()}); return false;"
                                    class="button button-action button-action-join {if $oBlog->getUserIsJoin()}active{/if}">
