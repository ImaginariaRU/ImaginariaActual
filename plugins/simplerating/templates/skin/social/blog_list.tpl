{if $aBlogs}
    {foreach from=$aBlogs item=oBlog}
        ...
        <div class="blog-item">
            <div class="blog-badge" id="blog_badge_{$oBlog->getId()}"
                 {if !$oUserCurrent or !$oBlog->getUserIsJoin()}style="display: none"{/if}></div>
            ...
            <dl>
                ...
                <dd>
                    ...
                    <a href="{router page='blog'}{$oBlog->getUrl()}/"
                       class="blog-header">{$oBlog->getTitle()|escape:'html'}</a>
                </dd>
            </dl>
            <dl>
