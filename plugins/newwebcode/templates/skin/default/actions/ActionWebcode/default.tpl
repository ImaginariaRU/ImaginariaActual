    ...
    <form action="{router page='webcode'}" method="post">
        {foreach $aEntities as $oEntity}
            <p>
                ...
                <textarea name="{$oEntity->getName()}" class="input-text input-width-full"
                          rows="5">{$oEntity->getCode()}</textarea>
...
<div>
    Плагин использует хранилище <a href="http://livestreetcms.com/addons/view/380/">ConfigEngine</a> от <a href="https://github.com/psnet">PSNet</a>.
</div>
