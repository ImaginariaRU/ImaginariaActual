    ...
    {foreach from=$aPages item=oPage name=el2}
        <tr>
            <td align="center">
                ...
                {else}
                    <a href="{router page='admin'}pages/sort/{$oPage->getId()}/?security_ls_key={$LIVESTREET_SECURITY_KEY}"
                ...
                {else}
                    <a href="{router page='admin'}pages/sort/{$oPage->getId()}/down/?security_ls_key={$LIVESTREET_SECURITY_KEY}"
