    ...
    {foreach $aBlogs as $aBlog}
        ...
        <tr>
            <td class="name">
                ...
                {/if}
                <a href="#" title="{$oLang->_adm_blog_delete}"
                   onclick="$ace.blog.del('{$oLang->Get('adm_blog_del_confirm', "blog=>$sBlogTitle")}','{$sBlogTitle}','{$aBlog.blog_id}'); return false;">
            ...
            <td class="center">{if $aBlog.blog_type!='personal'}
                <b>{/if}{$aBlog.blog_type}{if $aBlog.blog_type!='personal'}</b>{/if}</td>
            ...
            <td>
                ...
                {/if}
                {if $aBlog.attach_allow}<i class="icon icon-tags" title="{$oLang->_mblog_attach_allow_notice}"
                                           rel="tooltip">{/if}
                    {/if}
            </td>
        </tr>
