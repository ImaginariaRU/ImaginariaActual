    ...
    <div class=topic>
        ...
        <form action="" method="POST">
            ...
            <p>
                ...
                <input type="text" id="param_reserved_urls" name="param_reserved_urls" value="{$sParamPageUrlReserved}"
                       class="w100p"/><br/>
            ...
            <p>
                ...
                <input type="text" id="param_items_per_page" name="param_items_per_page" value="{$sParamItemsPerPage}"
                       class="w50"/><br/>
            ...
            <p>
                ...
                <input type="text" id="param_vote_value" name="param_vote_value" value="{$nParamVoteValue}"
                       class="w50"/><br/>
            ...
            <p>
                <label class="checkbox">{$oLang->adm_param_check_password}:
                    <input type="checkbox" id="param_check_password" name="param_check_password" value="1"
                           {if ($bParamCheckPassword)}checked{/if} /><br/>
                </label>
