...
{block name="content"}
    ...
    <div class="topic">
        ...
        <ul class="nav nav-tabs">
            ...
            <li {if $sMode=='ids' || $sMode==''}class="active"{/if}><a
                        href="{router page='admin'}banlist/users/">{$oLang->_adm_banlist_ids}</a></li>
            <li {if $sMode=='ips'}class="active"{/if}><a
                        href="{router page='admin'}banlist/ips/">{$oLang->_adm_banlist_ips}</a></li>
        </ul>
