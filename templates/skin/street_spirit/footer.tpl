			...
			<footer id="footer">
				...
				*}
				...
				<div class="copyright">
					...
					<div class="design-by">
						Дизайн — веб-студия <a href="http://stfalcon.com"><img src="{cfg name='path.static.skin'}/images/stfalcon.png" alt="stfalcon studio" />stfalcon.com</a>
						<div class="clear hidden">2013</div>
					</div>
				</div>
...
<script type="text/javascript">
    (function (d, w, c) {
        (w[c] = w[c] || []).push(function() {
            try {
                w.yaCounter34322520 = new Ya.Metrika({
                    id:34322520,
                    clickmap:true,
                    trackLinks:true,
...
<noscript><div><img src="https://mc.yandex.ru/watch/34322520" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
			</footer>
		</div>
	</div>
