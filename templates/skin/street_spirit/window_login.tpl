		...
		<div class="modal-content">
			...
			<div class="tab-content js-block-popup-login-content" data-type="login">
				...
				<form action="{router page='login'}" method="post" id="popup-login-form">
					...
					<p><input type="text" name="login" id="popup-login" placeholder="{$aLang.user_login}" class="input-text input-width-300" style="width: 322px"></p>
					
					<p><input type="password" name="password" id="popup-password" placeholder="{$aLang.user_password}" class="input-text input-width-300" style="width: 322px"></p>
			...
			<div data-type="registration" class="tab-content js-block-popup-login-content" style="display:none;">
				...
				<form action="{router page='registration'}" method="post" id="popup-registration-form">
					...
					<p><div class="clear"><label for="popup-registration-captcha">{$aLang.registration_captcha}</label></div>
			...
			<div data-type="reminder" class="tab-content js-block-popup-login-content" style="display:none;">
				...
				<form action="{router page='login'}reminder/" method="POST" id="popup-reminder-form">
					...
					<p><button type="submit" name="submit_reminder" class="button button-primary" id="popup-reminder-form-submit" disabled="disabled">{$aLang.password_reminder_submit}</button></p>
				</form>
			</div>
		</div>
	</div>
