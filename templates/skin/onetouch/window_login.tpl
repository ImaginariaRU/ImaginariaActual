		...
		<div class="modal-content">
			...
			<div class="tab-content js-block-popup-login-content" data-type="login">
				...
				<form action="{router page='login'}" method="post" id="popup-login-form">
					...
					<input type="text" name="login" placeholder="{$aLang.user_login}" id="popup-login" class="input-text input-width-300"></p>
					<input type="password" name="password" placeholder="{$aLang.user_password}" id="popup-password" class="input-text input-width-300">
			...
			<div data-type="registration" class="tab-content js-block-popup-login-content" style="display:none;">
				...
				<form action="{router page='registration'}" method="post" id="popup-registration-form">
					...
					<img src="{cfg name='path.root.engine_lib'}/kcaptcha/index.php?{$_sPhpSessionName}={$_sPhpSessionId}"
						 ...
						 class="captcha-image" />
					<input type="text" name="captcha" id="popup-registration-captcha" value="" maxlength="3" class="input-text cap input-width-100 js-ajax-validate" />
			...
			<div data-type="reminder" class="tab-content js-block-popup-login-content" style="display:none;">
				...
				<form action="{router page='login'}reminder/" method="POST" id="popup-reminder-form">
					<p><input type="text" name="mail" placeholder="{$aLang.password_reminder_email}" id="popup-reminder-mail" class="input-text input-width-300" />
